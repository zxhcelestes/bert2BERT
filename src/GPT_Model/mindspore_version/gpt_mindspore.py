...
class MaskedSelfAttention(nn.Cell):
    ...
    def construct(self, input_tensor, attention_mask):
        ...
        # print("ms_attn_weigts:")
        # print(attention_scores.value())
        # todo 这一样
...
class FeedForward(nn.Cell):
    ...
    def construct(self, input_tensor):
        ...
        # print("feedward_layernorm")
        # print(self.layernorm.layer_norm.gamma.value()[:10])
...
class MaskedMultiHeadAttention(nn.Cell):
    ...
    def construct(self, input_tensor, attention_mask):
        ...
        """
        # print("here:")
        # print(input_tensor.value())
        # print("MHA_layernorm")
        # print(self.layer_norm.layer_norm.gamma.value()[:10])
        # LayerNorm
        # todo 取消这个layernorm试试
        # output_tensor = self.layer_norm(input_tensor)
        output_tensor = input_tensor
        # print("here:")
        # print(output_tensor.value())
...
class DecoderBlock(nn.Cell):
    ...
    def construct(self, input_tensor, attention_mask):  # input tensor shape[batch_size, seq_length, n_embed]
        ...
        # print(f"ms_attention_output")
        # print(attention_output.value())
