...
class EmbeddingLookup(nn.Cell):
    ...
    Args:
        ...
        embedding_size (int): The size of each embeddings vector.
...
class RelaPosEmbeddingsGenerator(nn.Cell):
    ...
    def construct(self):
        """Generate embeddings for each relative position of dimension depth."""
...
class BertSelfAttention(nn.Cell):
    ...
    def __init__(self,
        ...
        self.output = BertOutput(in_channels=num_attention_heads * size_per_head,
